...
#####################################
#####creates png file for plot 2#####
#####################################
png(file="plot2.png",width=480,height=480)   ##creates plot2.png file
##creates the line graph of global active power
plot(targetData$Date_Time,targetData$Global_active_power,type="l",ylab="Global Active Power (kilowatts)",xlab="")
